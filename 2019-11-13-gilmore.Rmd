...
```{r,fig.cap="[Hotton & Yoshimi 2010](https://doi.org/10.1111/j.1551-6709.2010.01151.x)"}
knitr::include_graphics("img/hotton-yoshimi-2010.jpg")
```

## Challenges...

- Beyond qualitative dynamics
- How to characterize the relevant state spaces
- How to measure the relevant states (with sufficient resolution)
- What is controlled: perceptual states (PCT) or actions (ecological psychologists, forward modelers)
